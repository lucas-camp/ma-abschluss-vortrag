...
plt.plot(x, w_1, label="$\psi_{1{,}5; -7}(t)$", color="orange")
plt.plot(x, w_2, "--", color="orange", label="$\psi_{1{,}5; 5}(t)$")
...
if TIKZ:
    import tikzplotlib
    tikzplotlib.save("grafiken/python/tikz/dwt/mexican_hat_conv_2.tikz", axis_width="7cm")
else:
    plt.show()
    z = 0